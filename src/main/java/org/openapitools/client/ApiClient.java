...
public class ApiClient {
    ...
    private String basePath = "http://localhost:3000/platform/productCatalogManagement/v4";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:3000/platform/productCatalogManagement/v4
